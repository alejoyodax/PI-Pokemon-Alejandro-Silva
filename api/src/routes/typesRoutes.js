...
const { getAllTypesPokemon } = require('../controllers/typesControllers.js')
...
router.get("/", async (req, res, next) => {
    ...
    try {
        const allTypesPokemon = await getAllTypesPokemon()
        res.status(200).send(allTypesPokemon)
...
// AGREGAR POKEMONS Y SUS TIPOS A LA BASE DE DATOS. NO USAR
